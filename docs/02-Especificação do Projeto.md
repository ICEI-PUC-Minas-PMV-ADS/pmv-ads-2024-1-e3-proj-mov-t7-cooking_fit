...
|RF-004| Gerenciar refeições, oferecer a capacidade de personalizar planos alimentares com base nas preferências dietéticas, restrições alimentares e metas de saúde individuais dos usuários. | ALTA |
...
|RF-009| Surgerir de cardapio para o usuário, oferecendo uma alimentação controlada e saudável. | BAIXA |
|RF-010| A plataforma deve disponibilizar aos usuários uma barra de pesquisa eficiente que permite aos usuários buscar receitas específicas por nome ou ingredientes.   | ALTA |
|RF-011| A Plataforma deve disponibilizar uma ferramenta que permite aos usuários converter medidas de ingredientes por exemplo, xícaras para gramas. | BAIXA |
